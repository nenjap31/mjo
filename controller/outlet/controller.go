...
import (
	"database/sql"
	"mjo/controller/outlet/defined"
	"mjo/controller/util/queryparams"
	"mjo/controller/util/response"
	"mjo/service/outlet"
	serviceDefined "mjo/service/outlet/defined"
	"net/http"
...
type Controller struct {
	service outlet.IService
}

func NewController(service outlet.IService) *Controller {
	return &Controller{
		service: service,
	}
}
...
func (controller Controller) Create(c echo.Context) error {
	...
	data := serviceDefined.Outlet{
		MerchantId:      bodyRequest.MerchantId,
		OutletName:       sql.NullString{String: bodyRequest.OutletName, Valid:true},
